      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl w-full mx-10">
                <div>
                  <div className="mt-3 text-center sm:mt-5 flex-between">
                    <Dialog.Title
                      as="h3"
                ...
                <div className="mt-5 sm:mt-6 grid grid-cols-2 gap-6">
                  <button
                    type="button"
